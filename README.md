# Fuzzy Eve Notifier [![Win32-x64 Build Status](https://ci.appveyor.com/api/projects/status/github/prusya/fuzzy-eve-notifier?svg=true)](https://ci.appveyor.com/project/prusya/fuzzy-eve-notifier)
